...
namespace get_unconstrained
{
    class Program
    {
        ...
        {
            // get_unconstrained   -domain domainname
            // -server serverip
            ...
            ds.Filter = "(useraccountcontrol>= 524288)";
            ...
            foreach (SearchResult sr in ds.FindAll())
            {
                ...
                {
                    if(uacstring.ToUpper()== "TRUSTED_FOR_DELEGATION")
                    {
                        Console.WriteLine(sr.Properties["distinguishedname"][0]);
                    }
                }
