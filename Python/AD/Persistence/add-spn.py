...
parser.add_argument("--spn",required=True,help="Specify the spn string you want to add")
...
myconnection.search(args.searchbase if args.searchbase else namingcontext,
                    ...
                    "SUBTREE",attributes=[ "serviceprincipalname","distinguishedname"])
...
for i in myconnection.entries:
    ...
    myconnection.modify(str(i["distinguishedname"]),
                    {
                        "serviceprincipalname":[ (MODIFY_ADD, [args.spn])]
                    }    )
