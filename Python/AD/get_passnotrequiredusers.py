...
parser = argparse.ArgumentParser(prog="Get Users who's password not required to login",
                                 description="Retrieve users have PASSWD_NOTREQD  set")
...
myconnection.search(args.searchbase if args.searchbase else namingcontext,
                    "(&(objectclass=user)(useraccountcontrol>=31))",
